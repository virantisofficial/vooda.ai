...
class BatchTriageConfig:
    ...
    request_timeout: float = 120.0  # BACKSTOP wall-clock per LLM call (asyncio.wait_for). Streaming providers (OpenAIProvider) self-limit via connect/idle timeouts + a max_tokens-derived deadline; callers set this just above that deadline.
