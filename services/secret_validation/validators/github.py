...
"""GitHub token validator — uses GET /user."""
            ...
            async with httpx.AsyncClient(timeout=self.timeout) as client:
                resp = await client.get(
                    ...
                    headers={
                        ...
                        "User-Agent": "Vooda-AI-Secret-Scanner",
                    },
                )
            ...
            if resp.status_code == 200:
                ...
                return ValidationResult(
                    ...
                    details={
                        ...
                        "scopes": scopes,
                        "token_type": "fine_grained" if not scopes else "classic",
                    },
                )
                ...
                # Token exists but may be rate limited or IP restricted
                return ValidationResult(
                    status=ValidationStatus.ACTIVE,
                    provider=self.provider,
                    details={"response_code": 403, "note": "Token valid but access restricted"},
                )
            else:
                return ValidationResult(
